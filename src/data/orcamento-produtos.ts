...
export const tiposProduto: ProdutoOrcamento[] = [
  {
    value: 'janela_correr_2f',
    label: 'Janela de Correr 2F',
    precoM2: 850,
    category: 'janela_correr',
    subcategory: '2_folhas',
    numFolhas: 2,
    typologyId: 'typ-su-jc2f',
    imagem_url: typologyImages['typ-su-jc2f'],
    minLarguraCm: 80,
    maxLarguraCm: 400,
    minAlturaCm: 40,
    maxAlturaCm: 250,
  ...
  {
    value: 'janela_correr_4f',
    label: 'Janela de Correr 4F',
    precoM2: 880,
    category: 'janela_correr',
    subcategory: '4_folhas',
    numFolhas: 4,
    typologyId: 'typ-su-jc4f',
    imagem_url: typologyImages['typ-su-jc4f'],
    minLarguraCm: 160,
    maxLarguraCm: 600,
    minAlturaCm: 40,
    maxAlturaCm: 250,
  ...
  {
    value: 'janela_maximar_1f',
    label: 'Janela Maxim-Ar 1F',
    precoM2: 920,
    category: 'janela_maximar',
    subcategory: '1_folha',
    numFolhas: 1,
    typologyId: 'typ-su-jma1',
    imagem_url: typologyImages['typ-su-jma1'],
    minLarguraCm: 40,
    maxLarguraCm: 200,
    minAlturaCm: 40,
    maxAlturaCm: 150,
  ...
  {
    value: 'janela_maximar_2f',
    label: 'Janela Maxim-Ar 2F',
    precoM2: 950,
    category: 'janela_maximar',
    subcategory: '2_folhas',
    numFolhas: 2,
    typologyId: 'typ-su-jma2',
    imagem_url: typologyImages['typ-su-jma2'],
    minLarguraCm: 80,
    maxLarguraCm: 300,
    minAlturaCm: 40,
    maxAlturaCm: 150,
  ...
  {
    value: 'porta_giro_1f',
    label: 'Porta de Giro 1F',
    precoM2: 950,
    category: 'porta_giro',
    subcategory: '1_folha',
    numFolhas: 1,
    typologyId: 'typ-su-pg1f',
    imagem_url: typologyImages['typ-su-pg1f'],
    minLarguraCm: 60,
    maxLarguraCm: 130,
    minAlturaCm: 180,
    maxAlturaCm: 280,
  ...
  {
    value: 'porta_giro_2f',
    label: 'Porta de Giro 2F',
    precoM2: 1000,
    category: 'porta_giro',
    subcategory: '2_folhas',
    numFolhas: 2,
    typologyId: 'typ-su-pg2f',
    imagem_url: typologyImages['typ-su-pg2f'],
    minLarguraCm: 100,
    maxLarguraCm: 260,
    minAlturaCm: 180,
    maxAlturaCm: 280,
  ...
  {
    value: 'porta_correr_2f',
    label: 'Porta de Correr 2F',
    precoM2: 1050,
    category: 'porta_correr',
    subcategory: '2_folhas',
    numFolhas: 2,
    typologyId: 'typ-su-pc2f',
    imagem_url: typologyImages['typ-su-pc2f'],
    minLarguraCm: 100,
    maxLarguraCm: 400,
    minAlturaCm: 180,
    maxAlturaCm: 280,
  ...
  {
    value: 'porta_correr_4f',
    label: 'Porta de Correr 4F',
    precoM2: 1100,
    category: 'porta_correr',
    subcategory: '4_folhas',
    numFolhas: 4,
    typologyId: 'typ-su-pc4f',
    imagem_url: typologyImages['typ-su-pc4f'],
    minLarguraCm: 200,
    maxLarguraCm: 600,
    minAlturaCm: 180,
    maxAlturaCm: 280,
  ...
  {
    value: 'janela_veneziana',
    label: 'Janela c/ Veneziana 2F',
    precoM2: 1200,
    category: 'janela_correr',
    subcategory: '2_folhas',
    numFolhas: 2,
    veneziana: true,
    typologyId: 'typ-su-jc2fv',
    imagem_url: typologyImages['typ-su-jc2fv'],
    minLarguraCm: 80,
    maxLarguraCm: 400,
    minAlturaCm: 40,
    maxAlturaCm: 250,
  ...
  {
    value: 'janela_camarao',
    label: 'Janela Camarão',
    precoM2: 1300,
    category: 'janela_camarao',
    subcategory: '4_folhas',
    numFolhas: 4,
    typologyId: 'typ-su-jcam',
    imagem_url: typologyImages['typ-su-jcam'],
    minLarguraCm: 100,
    maxLarguraCm: 400,
    minAlturaCm: 40,
    maxAlturaCm: 200,
...
export const getProdutoByValue = (value: string) => tiposProduto.find(t => t.value === value);
...
export function validateDimensions(
  ...
  larguraCm: number,
  alturaCm: number
): { largura?: string; altura?: string } | null {
