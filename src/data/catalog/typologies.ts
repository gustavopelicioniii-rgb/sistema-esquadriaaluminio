...
const typologyImages: Record<string, string> = {
  ...
  "typ-go-jc3f": `${IMG_CDN}/tipologia-janela-correr-3p---photorealistic.png`,
  ...
  // Janela de Correr 6 Folhas
  "typ-su-jc6f": `${IMG_CDN}/tipologia-janela-correr-6p---photorealistic.png`,
  "typ-go-jc6f": `${IMG_CDN}/tipologia-janela-correr-6p---photorealistic.png`,
  // Janela de Correr 4F com Peitoril
  "typ-su-jc4fp": `${IMG_CDN}/tipologia-janela-correr-4p---photorealistic-02.png`,
  "typ-go-jc4fp": `${IMG_CDN}/tipologia-janela-correr-4p---photorealistic-02.png`,
  // Janela de Correr 2F com Bandeira
  "typ-su-jc2fb": `${IMG_CDN}/tipologia-janela-correr-2p---photorealistic-01.png`,
  ...
  "typ-su-pc3f": `${IMG_CDN}/tipologia-porta-correr-2p---photorealistic-03.png`,
  ...
  "typ-go-pg1f": `${IMG_CDN}/tipologia-porta-giro-1p---photorealistic.png`,
  "typ-tp-pg1f": `${IMG_CDN}/tipologia-porta-giro-1p---photorealistic.png`,
  // Porta de Giro 2 Folhas
  "typ-su-pg2f": `${IMG_CDN}/tipologia-porta-giro-2p---photorealistic.png`,
  "typ-go-pg2f": `${IMG_CDN}/tipologia-porta-giro-2p---photorealistic.png`,
  "typ-tp-pg2f": `${IMG_CDN}/tipologia-porta-giro-2p---photorealistic.png`,
  ...
  "typ-go-jpiv": `${IMG_CDN}/tipologia-porta-pivotante---photorealistic.png`,
  "typ-tp-jpiv": `${IMG_CDN}/tipologia-porta-pivotante---photorealistic.png`,
  // Maxim Air 1 Folha
  "typ-su-jma1": `${IMG_CDN}/tipologia-janela-maxair---photorealistic.png`,
  "typ-go-jma1": `${IMG_CDN}/tipologia-janela-maxair---photorealistic.png`,
  "typ-tp-jma1": `${IMG_CDN}/tipologia-janela-maxair---photorealistic.png`,
  // Maxim Air 2 Folhas
  "typ-su-jma2": `${IMG_CDN}/tipologia-janela-maxair---photorealistic.png`,
  "typ-go-jma2": `${IMG_CDN}/tipologia-janela-maxair---photorealistic.png`,
  // Box de Banheiro
  "typ-su-box": `${IMG_CDN}/tipologia-box---photorealistic.png`,
  "typ-go-box": `${IMG_CDN}/tipologia-box---photorealistic.png`,
  // Guarda Roupa
  ...
  // Janela com Veneziana / Persiana 2F
  ...
  // Janela com Veneziana / Persiana 4F
  ...
  "typ-go-vfix": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  "typ-tp-vfix": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  // Janela de Porão
  "typ-su-por": `${IMG_CDN}/tipologia-janela-porao---photorealistic.png`,
  "typ-go-por": `${IMG_CDN}/tipologia-janela-porao---photorealistic.png`,
  // Closet
  ...
  "typ-go-jcam": `${IMG_CDN}/tipologia-janela-correr-4p---photorealistic-02.png`,
  // Porta Camarão
  "typ-su-pcam": `${IMG_CDN}/tipologia-porta-correr-4p---photorealistic-04.png`,
  "typ-go-pcam": `${IMG_CDN}/tipologia-porta-correr-4p---photorealistic-04.png`,
  // Basculante 1 Folha
  "typ-su-jbas1": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  "typ-go-jbas1": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  // Basculante 2 Folhas
  "typ-su-jbas2": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  "typ-go-jbas2": `${IMG_CDN}/tipologia-janela-fixa---photorealistic.png`,
  // Porta Balcão
  "typ-su-pbal": `${IMG_CDN}/tipologia-janela-persiana---photorealistic-11.png`,
  "typ-go-pbal": `${IMG_CDN}/tipologia-janela-persiana---photorealistic-11.png`,
  "typ-tp-pbal": `${IMG_CDN}/tipologia-janela-persiana---photorealistic-11.png`,
  // Porta Integrada
  "typ-go-pint": `${IMG_CDN}/tipologia-porta-correr-2p---photorealistic-03.png`,
  "typ-tp-pint": `${IMG_CDN}/tipologia-porta-correr-2p---photorealistic-03.png`,
};
...
const supremaTypologies: (Typology & { imagem_url?: string })[] = [
  ...
  { id: "typ-su-jc3f", product_line_id: "line-suprema", name: "Janela de Correr 3 Folhas", category: "janela", subcategory: "correr", num_folhas: 3, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 900, max_width_mm: 5000, min_height_mm: 400, max_height_mm: 2500, imagem_url: typologyImages["typ-su-jc3f"] },
  ...
  { id: "typ-su-jc6f", product_line_id: "line-suprema", name: "Janela de Correr 6 Folhas", category: "janela", subcategory: "correr", num_folhas: 6, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1800, max_width_mm: 6000, min_height_mm: 400, max_height_mm: 2500, imagem_url: typologyImages["typ-su-jc6f"] },
  { id: "typ-su-jc4fp", product_line_id: "line-suprema", name: "Janela de Correr 4F c/ Peitoril Fixo", category: "janela", subcategory: "correr", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, notes: "Com peitoril fixo inferior", min_width_mm: 1200, max_width_mm: 6000, min_height_mm: 600, max_height_mm: 2500, imagem_url: typologyImages["typ-su-jc4fp"] },
  { id: "typ-su-jc2fb", product_line_id: "line-suprema", name: "Janela de Correr 2F c/ Bandeira Móvel", category: "janela", subcategory: "correr", num_folhas: 2, has_veneziana: false, has_bandeira: true, active: true, min_width_mm: 600, max_width_mm: 4000, min_height_mm: 600, max_height_mm: 2800, imagem_url: typologyImages["typ-su-jc2fb"] },
  // Maxim-Ar
  ...
  // Camarão
  { id: "typ-su-jcam", product_line_id: "line-suprema", name: "Janela Camarão (Sanfonada)", category: "camarao", subcategory: "camarao", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 5000, min_height_mm: 500, max_height_mm: 2500, imagem_url: typologyImages["typ-su-jcam"] },
  // Portas de Correr
  ...
  { id: "typ-su-pc3f", product_line_id: "line-suprema", name: "Porta de Correr 3 Folhas", category: "porta", subcategory: "correr", num_folhas: 3, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1500, max_width_mm: 6000, min_height_mm: 1900, max_height_mm: 3000, imagem_url: typologyImages["typ-su-pc3f"] },
  ...
  // Basculante
  { id: "typ-su-jbas1", product_line_id: "line-suprema", name: "Basculante 1 Folha", category: "basculante", subcategory: "basculante", num_folhas: 1, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 300, max_width_mm: 1200, min_height_mm: 300, max_height_mm: 800, imagem_url: typologyImages["typ-su-jbas1"] },
  { id: "typ-su-jbas2", product_line_id: "line-suprema", name: "Basculante 2 Folhas", category: "basculante", subcategory: "basculante", num_folhas: 2, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 600, max_width_mm: 2000, min_height_mm: 300, max_height_mm: 800, imagem_url: typologyImages["typ-su-jbas2"] },
  // Vitro Fixo
  ...
  // Porta Balcão
  { id: "typ-su-pbal", product_line_id: "line-suprema", name: "Porta Balcão 2F (Vidro+Veneziana)", category: "veneziana", subcategory: "correr", num_folhas: 2, has_veneziana: true, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 4000, min_height_mm: 1900, max_height_mm: 3000, imagem_url: typologyImages["typ-su-pbal"] },
  // Porta Camarão
  { id: "typ-su-pcam", product_line_id: "line-suprema", name: "Porta Camarão (Sanfonada)", category: "camarao", subcategory: "camarao", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 5000, min_height_mm: 1900, max_height_mm: 3000, imagem_url: typologyImages["typ-su-pcam"] },
];
...
const goldTypologies: (Typology & { imagem_url?: string })[] = [
  ...
  { id: "typ-go-jc3f", product_line_id: "line-gold", name: "Janela de Correr 3 Folhas", category: "janela", subcategory: "correr", num_folhas: 3, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 900, max_width_mm: 5500, min_height_mm: 400, max_height_mm: 2800, imagem_url: typologyImages["typ-go-jc3f"] },
  ...
  { id: "typ-go-jc6f", product_line_id: "line-gold", name: "Janela de Correr 6 Folhas", category: "janela", subcategory: "correr", num_folhas: 6, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1800, max_width_mm: 6000, min_height_mm: 400, max_height_mm: 2800, imagem_url: typologyImages["typ-go-jc6f"] },
  { id: "typ-go-jc4fp", product_line_id: "line-gold", name: "Janela de Correr 4F c/ Peitoril Fixo", category: "janela", subcategory: "correr", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1200, max_width_mm: 6000, min_height_mm: 600, max_height_mm: 2800, imagem_url: typologyImages["typ-go-jc4fp"] },
  // Maxim-Ar
  ...
  // Camarão
  { id: "typ-go-jcam", product_line_id: "line-gold", name: "Janela Camarão", category: "camarao", subcategory: "camarao", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 5500, min_height_mm: 500, max_height_mm: 2800, imagem_url: typologyImages["typ-go-jcam"] },
  // Portas de Correr
  ...
  // Porta Integrada
  { id: "typ-go-pint", product_line_id: "line-gold", name: "Porta Integrada (Correr + Fixo)", category: "porta", subcategory: "correr", num_folhas: 2, has_veneziana: false, has_bandeira: false, active: true, notes: "2 folhas de correr + 1 fixo", min_width_mm: 1500, max_width_mm: 6000, min_height_mm: 1900, max_height_mm: 3200, imagem_url: typologyImages["typ-go-pint"] },
  // Basculante
  { id: "typ-go-jbas1", product_line_id: "line-gold", name: "Basculante 1 Folha Gold", category: "basculante", subcategory: "basculante", num_folhas: 1, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 300, max_width_mm: 1400, min_height_mm: 300, max_height_mm: 900, imagem_url: typologyImages["typ-go-jbas1"] },
  // Vitrô Fixo
  ...
  // Porta Balcão
  { id: "typ-go-pbal", product_line_id: "line-gold", name: "Porta Balcão 2F Gold", category: "veneziana", subcategory: "correr", num_folhas: 2, has_veneziana: true, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 4500, min_height_mm: 1900, max_height_mm: 3200, imagem_url: typologyImages["typ-go-pbal"] },
  // Porta Camarão
  { id: "typ-go-pcam", product_line_id: "line-gold", name: "Porta Camarão Gold", category: "camarao", subcategory: "camarao", num_folhas: 4, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 1000, max_width_mm: 5500, min_height_mm: 1900, max_height_mm: 3200, imagem_url: typologyImages["typ-go-pcam"] },
];
...
const topTypologies: (Typology & { imagem_url?: string })[] = [
  ...
  // Porta Balcão
  { id: "typ-tp-pbal", product_line_id: "line-top", name: "Porta Balcão Top", category: "veneziana", subcategory: "correr", num_folhas: 2, has_veneziana: true, has_bandeira: false, active: true, min_width_mm: 1200, max_width_mm: 5000, min_height_mm: 2000, max_height_mm: 3500, imagem_url: typologyImages["typ-tp-pbal"] },
  // Pivotante
  { id: "typ-tp-jpiv", product_line_id: "line-top", name: "Janela Pivotante Top", category: "pivotante", subcategory: "pivotante", num_folhas: 1, has_veneziana: false, has_bandeira: false, active: true, min_width_mm: 500, max_width_mm: 1800, min_height_mm: 500, max_height_mm: 2500, imagem_url: typologyImages["typ-tp-jpiv"] },
];
