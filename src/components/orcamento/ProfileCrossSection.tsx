...
export function ProfileCrossSection({
  ...
  const renderShape = () => {
    ...
    if (type === "vidro") {
      return (
        <g>
          <rect x="8" y="6" width="24" height="28" stroke={stroke} fill={fill} strokeWidth={sw} rx="1" />
    ...
    if (type === "ferragem") {
      return (
        <g>
          ...
          <circle cx="20" cy="18" r="3" stroke={stroke} fill={stroke} strokeWidth={0.5} opacity={0.3} />
    ...
    if (type === "acessorio") {
      return (
        <g>
          ...
          <circle cx="20" cy="20" r="3" stroke={stroke} fill={stroke} strokeWidth={0.5} opacity={0.2} />
    ...
    if (type === "vedacao") {
      return (
        <g>
          ...
          <path d="M14 28 Q14 18 20 18 Q26 18 26 28" stroke={stroke} fill={stroke} strokeWidth={0.5} opacity={0.1} />
        </g>
      );
    }
    ...
    if (type === "puxador") {
      return (
        <g>
          <rect x="18" y="6" width="4" height="28" stroke={stroke} fill={fill} strokeWidth={sw} rx="2" />
    ...
    if (type === "fechadura") {
      return (
        <g>
          <rect x="12" y="16" width="16" height="14" stroke={stroke} fill={fill} strokeWidth={sw} rx="1" />
          <path d="M15 16 L15 12 Q15 8 20 8 Q25 8 25 12 L25 16" stroke={stroke} fill={fill} strokeWidth={sw} />
          <circle cx="20" cy="23" r="2.5" stroke={stroke} fill={stroke} strokeWidth={0.5} opacity={0.3} />
