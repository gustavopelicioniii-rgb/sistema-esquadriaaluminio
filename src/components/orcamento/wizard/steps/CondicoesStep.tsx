    ...
    <div className="max-w-xl mx-auto p-3 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-0">
          <span className="flex items-center justify-center h-10 w-10 bg-primary text-primary-foreground rounded-l-md text-sm font-bold">
            %
          </span>
          <Input
            type="number"
      ...
      <div className="space-y-2">
        <div className="grid grid-cols-2 gap-0">
          <button
            onClick={() => onTemAcrescimoChange(false)}
            className={cn(
          ...
          <button
            onClick={() => onTemAcrescimoChange(true)}
            className={cn(
        ...
        {temAcrescimo && (
          <div className="flex items-center gap-2">
            ...
            <Input
              type="number"
              value={acrescimo}
              onChange={e => onAcrescimoChange(Number(e.target.value))}
              placeholder="0,00"
              min={0}
            />
          </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          ...
          <Input
            type="number"
            value={descontoValor}
            onChange={e => onDescontoValorChange(Number(e.target.value))}
            placeholder="0"
            min={0}
            className="w-32"
          />
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-0">
          ...
          <Input
            type="number"
            value={parcelas}
            onChange={e => onParcelasChange(Math.max(1, Number(e.target.value)))}
