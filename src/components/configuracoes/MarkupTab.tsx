  ...
  const handleSave = async () => {
    ...
    try {
      if (editingId) {
        ...
        const { error } = await supabase.from('markup_config').insert([
          {
              ...
              <tbody>
                {configs.map(config => (
                  <tr key={config.id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="py-3 px-2 text-muted-foreground text-xs">{config.obs || '—'}</td>
                    <td className="py-3 px-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setEditData(prev => ({
                      ...prev,
                      custo_base_m2: parseFloat(e.target.value) || 0,
                    }))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setEditData(prev => ({
                      ...prev,
                      margem_percent: parseInt(e.target.value) || 0,
                    }))
                  }
                />
              </div>
