...
export function SetupTab({ onComplete, onSwitchToEmpresa }: SetupTabProps) {
  ...
  const [setupData, setSetupData] = useState({
    nomeEmpresa: "", cnpj: "", telefone: "", email: "",
    endereco: "", cidade: "", estado: "",
    segmento: "esquadrias_aluminio", numFuncionarios: "1-5",
    usaNotaFiscal: false, usaWhatsapp: false,
  });
  ...
  const handleSetupComplete = async () => {
    ...
    const entries: Record<string, string> = {
      nome: setupData.nomeEmpresa, cnpj: setupData.cnpj, telefone: setupData.telefone,
      email: setupData.email, endereco: setupData.endereco, cidade: setupData.cidade, estado: setupData.estado,
    };
      ...
      <CardContent>
        ...
        {setupStep >= 4 && (
          <div className="text-center py-8 space-y-4">
            ...
            <Button variant="outline" onClick={() => { setSetupStep(0); onSwitchToEmpresa(); }}>
              Ver Configurações
            </Button>
          </div>
        )}
