...
let _filterId = 0;
let _shadowId = 0;
function nextShadowId() {
  return `shadow-${++_shadowId}`;
}
function nextId() {
  return `id-${++_filterId}-${Math.random().toString(36).slice(2, 7)}`;
}
