    ...
    <Card className={cn('overflow-hidden', className)}>
      <CardHeader className="pb-2">
        ...
        <div className="flex gap-4 text-xs text-muted-foreground">
          ...
          <span>
            {num_folhas} folha{num_folhas > 1 ? 's' : ''}
          </span>
        </div>
      </CardHeader>
        ...
        <div className="relative bg-gradient-to-b from-slate-900 to-slate-800 h-[300px] flex flex-col items-center justify-center">
          ...
          >
            ...
            >
              ...
              {num_folhas === 2 && (
                <div
                  className="absolute left-1/2 top-0 bottom-0 w-1 bg-inherit -translate-x-1/2"
              ...
              {num_folhas === 4 && (
                <>
                  ...
                  />
                  <div
                    className="absolute top-1/2 left-0 right-0 h-1 bg-inherit -translate-y-1/2"
                    style={{ backgroundColor: frameColor }}
                  />
                </>
              )}
          ...
          <div className="mt-4 text-center">
            ...
            <p className="text-white/40 text-xs">3D completo disponível em breve</p>
          </div>
