import {
  Bell, Package, DollarSign, Wrench, Users,
  AlertTriangle, AlertCircle, Info,
} from "lucide-react";
import type { NotificationType } from "@/hooks/use-notifications";

export const typeConfig: Record<NotificationType, { icon: typeof Package; label: string; color: string; bgColor: string; route: string }> = {
