...
const searchableItems = [
  ...
  { label: "Ana Costa", type: "Cliente", url: "/clientes" },
  { label: "Pedro Souza", type: "Cliente", url: "/clientes" },
  { label: "Empresa Modelo Ltda", type: "Cliente", url: "/clientes" },
  ...
  { label: "#1044 - Arquitetura Moderna", type: "Orçamento", url: "/orcamentos" },
  ...
  { label: "Janela Maxim-Ar 2F", type: "Produto", url: "/produtos" },
  { label: "Porta de Correr 3F", type: "Produto", url: "/produtos" },
];
...
const notifications = [
  ...
  { id: "4", msg: "Pagamento recebido - Residência Costa R$ 950", time: "1d", read: true },
];
