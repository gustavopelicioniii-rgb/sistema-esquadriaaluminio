...
export function ProjetoDetalhe({
  ...
  const areaTotal = projeto.itens.reduce(
    (sum, it) =>
      sum + calcAreaEfetiva(it.larguraMm, it.alturaMm, projeto.areaMinimaM2) * it.quantidade,
    0
  );
    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            className="gap-2"
            onClick={async () => {
              await onArchive(projeto.id, !projeto.archived);
            }}
          >
            {projeto.archived ? (
              ...
              <Table>
                ...
                <TableBody>
                  {projeto.itens.map(item => {
                    ...
                    const areaEfetiva = calcAreaEfetiva(
                      item.larguraMm,
                      item.alturaMm,
                      projeto.areaMinimaM2
                    );
                    const areaTotalItem = areaEfetiva * item.quantidade;
                    const isMinApplied =
                      projeto.areaMinimaM2 > 0 && areaReal < projeto.areaMinimaM2;
                    return (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                type="number"
                step="0.01"
                value={editAreaMinima}
                onChange={e => setEditAreaMinima(Number(e.target.value))}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  type="number"
                  value={itemLarg}
                  onChange={e => setItemLarg(Number(e.target.value))}
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Input
                  type="number"
                  value={itemAlt}
                  onChange={e => setItemAlt(Number(e.target.value))}
                />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Ex: temperado com furo, cantos lapidados"
              />
            </div>
            <div className="bg-muted/50 rounded-lg p-3 text-sm space-y-1">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono font-semibold">
                  {(calcAreaEfetiva(itemLarg, itemAlt, projeto.areaMinimaM2) * itemQtd).toFixed(4)}{' '}
                  m²
                </span>
              </div>
            </div>
      ...
      <Dialog open={csvOpen} onOpenChange={setCsvOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Importar Vidros via CSV</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Formato:{' '}
              <code className="text-xs bg-muted px-1 rounded">
                Descrição;Largura(mm);Altura(mm);Qtd;Observação
              </code>
            </p>
      ...
      <AlertDialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              O projeto <strong>"{projeto.titulo}"</strong> e todos os seus vidros serão excluídos
