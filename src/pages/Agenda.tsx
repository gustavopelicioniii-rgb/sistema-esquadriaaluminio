      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-xs sm:text-sm">
            Compromissos e eventos agendados
          </p>
        </div>
        <Button className="gap-2 text-xs sm:text-sm" onClick={() => openNew()}>
                ...
                {calendarDays.map((day, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {hasEvents && (
                        <span
                          className={`absolute bottom-1 left-1/2 -translate-x-1/2 h-1.5 w-1.5 rounded-full ${isSelected ? 'bg-primary-foreground' : 'bg-primary'}`}
                        />
                      )}
                    </button>
                  );
        ...
        <div className="space-y-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex flex-wrap gap-x-3 gap-y-1 mt-1 text-xs text-muted-foreground">
                        <span className="flex items-center gap-1">
                          ...
                          {new Date(evento.data + 'T12:00').toLocaleDateString('pt-BR')}
                        </span>
                        {evento.hora && (
                          <span className="flex items-center gap-1">
          ...
          {selectedDate && dayEvents.length === 0 && (
            <p className="text-sm text-muted-foreground text-center py-4">
              ...
              <Button variant="link" size="sm" onClick={() => openNew(selectedDate)}>
                Criar evento
              </Button>
            </p>
          )}
